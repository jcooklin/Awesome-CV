...
%---------------------------------------------------------
  \cventry
    {Peer Mediator} % Job title
    {Forest Grove High School} % Organization
...
%---------------------------------------------------------
  \cventry
    {AVID Recruiter and Representative} % Job title
    {Forest Grove High School} % Organization
    {Forest Grove} % Location
    {2017 - Present} % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    {Regular Babysitter (weekly)} % Job title
...
%---------------------------------------------------------
  \cventry
    {Barista} % Job title
    {Red Mountain Church} % Organization
...
%---------------------------------------------------------
  \cventry
    {Vice President of NEHS} % Job title
    {Red Mount Elementary School} % Organization
    {Mesa, AZ} % Location
    {Dec. 2014} % Date(s)
    {
      % \begin{cvitems} % Description(s) of tasks/responsibilities
